...
continue
su = sym.strip().upper()
# basic sanitation: skip tickers with spaces/slashes/dots
...
# average volume: previous 30 days (exclude today)
vol_series = hist["Volume"].shift(1).dropna()
...
triggers.append(f"Breakout20d > {high20:.2f}")
if pos_news:
